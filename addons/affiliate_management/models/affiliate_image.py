...
class AffiliateImage(models.Model):
    ...
    user_id = fields.Many2one('res.users', string='current user', index=True, track_visibility='onchange',
...
class ProductImageSize(models.Model):
    _name = "product.image.size"

    name = fields.Char('Image Size')
    image_height = fields.Integer(string="Height")
    image_width = fields.Integer(string="Width")
