    ...
    def slider_data(self, **kwargs):
        ...
        if slider_obj:
            if slider_obj.slider_type == 'product':
                ...
                domain = [('website_id', 'in', (False, request.website.get_current_website().id)),
                          ('parent_id', '=', False)]
...
class emiproThemeBaseExtended(WebsiteSaleWishlist):
    ...
    def get_combination_info_website(self, product_template_id, product_id, combination, add_qty, **kw):
        ...
        res = super(emiproThemeBaseExtended, self).get_combination_info_website(product_template_id=product_template_id,
